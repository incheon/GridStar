...
<head>
	...
	<script type="text/javascript" src="gridstr_edit.js"></script>
...
<table>
	<tr>
		...
		<td>
			<div class="alignC">
				<button  style="background-color:green ;color:white;height:40px;" class="btn btn-primary" id="add">追加</button>
			</div>
		</td>
		<td>
			<div class="alignC">
